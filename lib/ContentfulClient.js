...
class ContentfulClient {
    ...
    constructor({accessToken, spaceId, environmentId = "master", preview = false, include = 10, limit = 1000}) {
        ...
        this._serverUrl = preview
            ? PREVIEW_URL
            : PRODUCTION_URL;
        this._baseUrl = `${this._serverUrl}/spaces/${spaceId}/environments/${environmentId}/entries?access_token=${accessToken}`;
    ...
    get spaceId() { return this._spaceId; }
    ...
    async query(parameters) {
        ...
        // add query string
        const query = Object.assign({}, this._baseParameters, parameters);
